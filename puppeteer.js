...
async function app() {
    ...
    await page.goto("https://animixplay.to/api/liveTVRZME1ETTRMVFhzM0dyVTh3ZTlPVFZSWk1FMUVUVFE9", { waitUntil: 'load', timeout: 0 , referer: 'https://animixplay.to'})
    ...
    // await page.click("video");
    // const sr = await page.$$eval('video', el => el.map( x => x.getAttribute("src")))
    // console.log(sr)
